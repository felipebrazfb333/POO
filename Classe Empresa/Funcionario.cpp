...
void Funcionario::setSalarioBase(double salario){ salarioBase = salario; }

void Funcionario::setCHMensal(int h){ cargaHorariaMensal = h; }

void Funcionario::setHorasTrabalhadas(int ht){ qtdeHorasTrabalhadas = ht; }

string Funcionario::getMatricula() const{ return matricula; }

double Funcionario::getSalarioBase() const{ return salarioBase; }

int Funcionario::getCHMensal() const{ return cargaHorariaMensal; }
  
int Funcionario::getHorasTrabalhadas() const{ return qtdeHorasTrabalhadas; }
    
double Funcionario::calculaSalarioBruto() const { return salarioBase * qtdeHorasTrabalhadas/cargaHorariaMensal; }
